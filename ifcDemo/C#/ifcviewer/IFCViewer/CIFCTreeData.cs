...
namespace IFCViewer
{
    ...
    class CIFCTreeData
    {
        ...
        private void CreateHeaderTreeItems()
        {
            ...
            int i = 0;
            IntPtr description;
            while (IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 0, i++, IfcEngine.x86.sdaiSTRING, out description) == 0)
            {
            ...
            IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 1, 0, IfcEngine.x86.sdaiSTRING, out implementationLevel);
            ...
            // Name
            IntPtr name;
            IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 2, 0, IfcEngine.x86.sdaiSTRING, out name);
            ...
            // TimeStamp
            IntPtr timeStamp;
            IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 3, 0, IfcEngine.x86.sdaiSTRING, out timeStamp);
            ...
            i = 0;
            IntPtr author;
            while (IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 4, i++, IfcEngine.x86.sdaiSTRING, out author) == 0)
            {
            ...
            i = 0;
            IntPtr organization;
            while (IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 5, i++, IfcEngine.x86.sdaiSTRING, out organization) == 0)
            {
            ...
            IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 6, 0, IfcEngine.x86.sdaiSTRING, out preprocessorVersion);
            ...
            IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 7, 0, IfcEngine.x86.sdaiSTRING, out originatingSystem);
            ...
            IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 8, 0, IfcEngine.x86.sdaiSTRING, out authorization);
            ...
            i = 0;
            IntPtr fileSchema;
            while (IfcEngine.x86.GetSPFFHeaderItem(_ifcModel, 9, i++, IfcEngine.x86.sdaiSTRING, out fileSchema) == 0)
            {
        ...
        void GetColor(IFCTreeItem ifcTreeItem)
        {
            ...
            for (int iRepresentation = 0; iRepresentation < iRepresentationsCount; iRepresentation++)
            {
                ...
                IfcEngine.x86.sdaiGetAttrBN(iShapeInstance, "RepresentationIdentifier", IfcEngine.x86.sdaiSTRING, out representationIdentifier);
        ...
        void searchDeeper(IFCTreeItem ifcTreeItem, int iParentInstance)
        {
            ...
            else
            {
                if (IsInstanceOf(iParentInstance, "IFCMAPPEDITEM"))
                {
                    ...
                    {
                        IntPtr representationIdentifier;
                        IfcEngine.x86.sdaiGetAttrBN(mappedRepresentation.ToInt32(), "RepresentationIdentifier", IfcEngine.x86.sdaiSTRING, out representationIdentifier);
...
//            string strIfcType = Marshal.PtrToStringAnsi(ifcType);
            ...
            IntPtr name;
            IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "Name", IfcEngine.x86.sdaiSTRING, out name);

            string strName = Marshal.PtrToStringAnsi(name);

            IntPtr description;
            IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "Description", IfcEngine.x86.sdaiSTRING, out description);
        ...
        private void CreatePropertyTreeItem(IFCTreeItem ifcParent, IFCTreeItem ifcItem, string strProperty)
        {
            ...
            switch (strProperty)
            {
                case "IFCQUANTITYLENGTH":
                    {
                        IntPtr value;
                        IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "LengthValue", IfcEngine.x86.sdaiSTRING, out value);
                ...
                case "IFCQUANTITYAREA":
                    {
                        IntPtr value;
                        IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "AreaValue", IfcEngine.x86.sdaiSTRING, out value);
                ...
                case "IFCQUANTITYVOLUME":
                    {
                        IntPtr value;
                        IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "VolumeValue", IfcEngine.x86.sdaiSTRING, out value);
                ...
                case "IFCQUANTITYCOUNT":
                    {
                        IntPtr value;
                        IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "CountValue", IfcEngine.x86.sdaiSTRING, out value);
                ...
                case "IFCQUANTITYWEIGTH":
                    {
                        IntPtr value;
                        IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "WeigthValue", IfcEngine.x86.sdaiSTRING, out value);
                ...
                case "IFCQUANTITYTIME":
                    {
                        IntPtr value;
                        IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "TimeValue", IfcEngine.x86.sdaiSTRING, out value);
                ...
                case "IFCPROPERTYSINGLEVALUE":
                    {
                        IntPtr value;
                        IfcEngine.x86.sdaiGetAttrBN(ifcItem.instance, "NominalValue", IfcEngine.x86.sdaiSTRING, out value);
