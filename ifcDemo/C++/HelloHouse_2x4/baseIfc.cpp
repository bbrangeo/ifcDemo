...
int	    createEmptyIfcFile(char * ifcSchemaName, bool objectsWillBeAdded, char * lengthUnitConversion)
{
...
int		buildPostalAddress()
{
    if  (! ifcPostalAddressInstance) {
		...
		sdaiAppend((int) addressLines, sdaiSTRING, "RDF Ltd.");
		sdaiAppend((int) addressLines, sdaiSTRING, "Main Office");
