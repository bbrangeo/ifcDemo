...
//void	CreateIfcElementQuantity(int_t ifcModel, STRUCT__IFC__OBJECT * ifcObject, int_t ifcPropertySetInstance, STRUCT__SIUNIT * units)
...
//void	CreateIfcPropertySet(int_t ifcModel, STRUCT__IFC__OBJECT * ifcObject, int_t ifcPropertySetInstance, STRUCT__SIUNIT * units)
...
//void	CreateTypeObjectInstance(int_t ifcModel, STRUCT__IFC__OBJECT * ifcObject, int_t ifcTypeObjectInstance, STRUCT__SIUNIT * units)
...
//void	CreateRelDefinesByProperties(int_t ifcModel, STRUCT__IFC__OBJECT * ifcObject, int_t ifcRelDefinesByProperties, STRUCT__SIUNIT * units)
...
//void	CreateIfcInstanceProperties(int_t ifcModel, STRUCT__IFC__OBJECT * ifcObject, int_t ifcObjectInstance, STRUCT__SIUNIT * units)
